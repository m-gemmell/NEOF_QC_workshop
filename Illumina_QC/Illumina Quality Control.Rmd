...
column_1 <- c(
 ...
 '[![](figures/cluster.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#cluster)',
 #3 Good q
    '[**Good Illumina data**](#goodtutorial)', 
 '[![](figures/bacteria.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#goodtutorial)',
 #5 QC exercise
   '[**QC exercise**](#qcexercise)', 
 '[![](figures/exercise.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#qcexercise)',
 #7 Appendix
   '[**Appendix**](#usefultools)', 
 '[![](figures/toolbox.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#usefultools)'
)
column_2 <- c(
  #2 setup
  '[**Setup**](#setupchap)', 
 '[![](figures/start.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#setupchap)',
 #4 poorer q
   '[**Poorer Illumina data**](#poortutorial)', 
 '[![](figures/bacteria_2.png){style="height:150px; background:white; border-radius:5px; border: white solid 5px"}](#poortutorial)',
 #6 MultiQC
   '[**MultiQC**](#multiqcchap)', 
 '[![](figures/multiqc_logo_color.png){style="height:100px; background:white; border-radius:5px; border: white solid 5px"}](#multiqcchap)',
 #8 empty
 "",""
)
...
<center>
![](figures/cluster.png){style="width:200px; background: white; border-radius:5px"}
</center>
...
-   For more information on bash escape please see our [Intro to unix materials](https://neof-workshops.github.io/Unix_nxcdf7/Course/05-Tips_and_tricks.html#bash-escape)
...
For more information on wildcard characters please see our [Intro to unix materials](https://neof-workshops.github.io/Unix_nxcdf7/Course/12-Advanced_linux_practice.html#wildcard-characters)
`r unhide()`
...
<center>
![](figures/exercise.png){style="width:200px; background: white; border-radius:5px"}
</center>

Now you will carry out Quality checking and control of a whole genome shotgun study and a 16S rRNA study. 
You will run through the Quality checking and Quality control using the examples to help you. There will be questions to answer. 
After the question there will be info on the data and what the QC has shown.

## Whole shotgun metagenomics {#shotgun}
<center>
![](figures/kraken.png){style="width:200px; background: white; border-radius:5px"}
</center>
...
In previous tests I have trimmed off the first 20bps to remove this bias and not removed the first 20bp. I found there was little difference in the downstream results for the two methods. I therefore normally retain the first 20bp.
...
<center>
![](figures/chime.png){style="width:200px; background: white; border-radius:5px"}
</center>

Before starting this exercise I must note this is not the normal method to quality control 16S rRNA data. Both QIIME2 and other 16S pipelines have their own methods but it can be useful to check the quality of 16S rRNA data beofre analysis.
...
# MultiQC {#multiqcchap}
<center>
![](figures/multiqc_logo_color.png){style="width:400px; border-radius:15px; border:5px solid white; background:white"}
</center>
