...
Initialise environment. This needs to be done if you start working in a new terminal. Each terminal will only rmember what you have told it.

```{bash eval=FALSE}
source ONT_QC_env.sh
```
